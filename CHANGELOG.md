...
- Bump CLI from v2.30.4 to v3.7.0 ([#2](https://github.com/AliReza99/sentry-react-native/pull/2))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#370)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.30.4...3.7.0)
